...
statuslist = [['Mert', 'Uzeken', '4212155214'],
             ['Mama', 'home', '02149210'],
             ['Naem', '(thai)', '032 231342'],
             ['Cagla', 'Yetkin', '0972418709']]
...
def make_window():
    ...
    Label(frame1, text="Lastname").grid(row=1, column=0, sticky=W)
    genrevar = StringVar()
    genre = Entry(frame1, textvariable=genrevar)
    genre.grid(row=1, column=1, sticky=W)

    Label(frame1, text="Number").grid(row=2, column=0, sticky=W)
    statusvar = StringVar()
